...
document.getElementById('pop-settings').addEventListener('click', function(e) {
  ...
  if (act.dataset.action === 'csv-template') { e.preventDefault(); downloadCSVTemplate(); }
